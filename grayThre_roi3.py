...
def roi_thre3(videoWidth=640,videoHeight=360,nzones=0):
    import cv2
    from roi_define import define_roi
    from roi_define3b import define_roi3b
    # ************** GRAY LEVEL SETUP ********************** # 
    def nothing(x):
        pass
...
#    nzones = 4
    pts_tg, zones_xy = define_roi3b(frame0,nzones)
    # ************** END OF SETUP ********************** # 
...
#    cv2.waitKey(1)
    print("Hello You")
    return low_thre, high_thre, pts, zones_xy 
